<?php
 ...
 <head>
     ...
     <link rel="icon" type="image/png" href="image/PNGPIX-COM-FedEx-Logo-PNG-Transparent.png">
            ...
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <img src="image/PNGPIX-COM-FedEx-Logo-PNG-Transparent.png" width="65px">
                        <span>Bookstore</span>
                    </a>
                </li>
            </ul>
    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="slide/stack-of-books.png" class="d-block w-100">
            </div>
            <div class="carousel-item">
                <img src="slide/download.jfif" class="d-block w-100">
            </div>
            <div class="carousel-item">
                <img src="slide/book.jpg" class="d-block w-100">
            </div>
        </div>
            ...
            <?php foreach ($query as $buku): ?>
                <div class="card col-4">
                    ...
                    <div class="card-footer text-center">
                        <button type="button" class="btn btn-sm btn-primary" onclick='Detail(<?php echo json_encode($buku); ?>)'
